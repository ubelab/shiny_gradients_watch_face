...
public final class NatureGradientsWatchFaceUtil {
    ...
    /**
     * The {@link DataMap} key for {@link ShinyGradientsFace} background color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_BACKGROUND_COLOR = "BACKGROUND_COLOR";

    /**
     * The {@link DataMap} key for {@link ShinyGradientsFace} hour digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_HOURS_COLOR = "HOURS_COLOR";

    /**
     * The {@link DataMap} key for {@link ShinyGradientsFace} minute digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_MINUTES_COLOR = "MINUTES_COLOR";

    /**
     * The {@link DataMap} key for {@link ShinyGradientsFace} second digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_SECONDS_COLOR = "SECONDS_COLOR";

    /**
     * The path for the {@link DataItem} containing {@link ShinyGradientsFace} configuration.
     */
    public static final String PATH_WITH_FEATURE = "/watch_face_config/shinywf";
    ...
    /**
     * Asynchronously fetches the current config {@link DataMap} for {@link ShinyGradientsFace}
